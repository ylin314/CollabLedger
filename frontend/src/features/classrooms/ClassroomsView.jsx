...
function ClassroomsView({ currentUser, onToast, onBack, embedded = false }) {
  ...
  return <div className="app-shell classroom-shell"><aside className="sidebar">
    ...
    <div className="sidebar-bottom"><div className="profile-chip"><img className="avatar avatar-me avatar-image" src={currentUser?.avatar_url || defaultAvatar} alt="头像" /><div className="profile-chip-main"><strong>{currentUser?.name || "当前用户"}</strong><span>查看个人资料</span></div></div></div>
  </aside><main className="main-content"><div className="page-section classroom-page">{content}</div></main></div>;
}
