...
- [x] 登录注册、项目创建/切换、总览、看板、打卡、评价、贡献、推荐、报告与 Agent 对话
- [x] C1：完成 `main.tsx`、功能目录拆分、集中 API 层、类型定义、显式 React Router 路由、TanStack Query 项目数据查询和 Vitest 测试工程；存量 JSX 可继续渐进迁移，不阻塞当前验收
...
- [x] 前端视觉重构：数字账本视觉、Lucide 图标、MiSans/得意黑字体、桌面与 390px 窄屏适配
- [x] C10：历史项目页面、班级成员页、同班成员履历查看已完成；仍待补充画像计算和更细粒度数据授权，不使用假数据
